...
The design was validated through simulation and synthesised for the Altera DE1-SoC (Cyclone V), achieving real-time throughput with minimal logic utilisation.

The project is split into two parts:

- **Part 1 — XTEA Duplex Core:** Standalone encryption and decryption pipeline verified against known test vectors
- **Part 2 — Cryptography System:** Full system integrating IP traffic generators, a NoC mini-router, and the XTEA core

---

## Synthesis Results (Part 1 — DE1-SoC, Cyclone V)
...
```
├── XTEA_simulation/        # Part 1 simulation files
│   ├── xtea_enc.vhd
│   ├── xtea_dec.vhd
│   ├── xtea_top_duplex.vhd
│   └── xtea_tb.vhd
│
├── CS_simulation/          # Part 2 simulation files
│   ├── cs_top.vhd
│   ├── mini_router.vhd
│   ├── xtea_enc.vhd
│   ├── xtea_dec.vhd
...
│   └── cs_tb.vhd
│
├── XTEA_FPGA/              # Part 1 Quartus project (DE1-SoC)
├── CS_FPGA/                # Part 2 Quartus project (DE1-SoC)
...
### Part 2 — GHDL (using VHDL generator replacements)
